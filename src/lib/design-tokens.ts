...
export const SHADOW = {
  CARD: "0 1px 3px rgba(45, 58, 74, 0.06), 0 1px 2px rgba(45, 58, 74, 0.04)", // resting card — barely visible
  CARD_HOVER: "0 4px 16px rgba(45, 58, 74, 0.10), 0 1px 4px rgba(45, 58, 74, 0.06)", // lifted card on hover
  DROPDOWN: "0 8px 24px rgba(0,0,0,0.10), 0 2px 6px rgba(0,0,0,0.06)", // --shadow-dropdown
  MODAL: "0 8px 32px rgba(45, 58, 74, 0.12), 0 2px 8px rgba(45, 58, 74, 0.08)", // --shadow-modal
  NAV: "0 1px 0 rgba(45, 58, 74, 0.10)", // --shadow-nav
  AMBIENT: "0 4px 20px -2px rgba(45, 58, 74, 0.04), 0 12px 40px -4px rgba(45, 58, 74, 0.08)", // --shadow-ambient
} as const;
