...
export const Button: FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`button_wrap inline-flex items-center justify-center gap-2 select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#3182f6]${className ? ` ${className}` : ""}`}
      style={{ ...baseStyle, ...SIZE_STYLES[size] }}
    >
